...
static void mavlink_test_param_calib_rc(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_param_calib_rc >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_param_calib_rc_t packet_in = {
        17235,17339,17443,17547,17651,17755,17859,17963,18067,18171,18275,18379,18483,18587,18691,18795,18899,19003,19107,19211,19315,19419,19523,19627
    };
    mavlink_param_calib_rc_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.RC1_MAX = packet_in.RC1_MAX;
        packet1.RC1_MIN = packet_in.RC1_MIN;
        packet1.RC2_MAX = packet_in.RC2_MAX;
        packet1.RC2_MIN = packet_in.RC2_MIN;
        packet1.RC3_MAX = packet_in.RC3_MAX;
        packet1.RC3_MIN = packet_in.RC3_MIN;
        packet1.RC4_MAX = packet_in.RC4_MAX;
        packet1.RC4_MIN = packet_in.RC4_MIN;
        packet1.RC5_MAX = packet_in.RC5_MAX;
        packet1.RC5_MIN = packet_in.RC5_MIN;
        packet1.RC6_MAX = packet_in.RC6_MAX;
        packet1.RC6_MIN = packet_in.RC6_MIN;
        packet1.RC7_MAX = packet_in.RC7_MAX;
        packet1.RC7_MIN = packet_in.RC7_MIN;
        packet1.RC8_MAX = packet_in.RC8_MAX;
        packet1.RC8_MIN = packet_in.RC8_MIN;
        packet1.RC9_MAX = packet_in.RC9_MAX;
        packet1.RC9_MIN = packet_in.RC9_MIN;
        packet1.RC10_MAX = packet_in.RC10_MAX;
        packet1.RC10_MIN = packet_in.RC10_MIN;
        packet1.RC11_MAX = packet_in.RC11_MAX;
        packet1.RC11_MIN = packet_in.RC11_MIN;
        packet1.RC12_MAX = packet_in.RC12_MAX;
        packet1.RC12_MIN = packet_in.RC12_MIN;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_param_calib_rc_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_param_calib_rc_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_param_calib_rc_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_param_calib_rc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_param_calib_rc_pack(system_id, component_id, &msg , packet1.RC1_MAX , packet1.RC1_MIN , packet1.RC2_MAX , packet1.RC2_MIN , packet1.RC3_MAX , packet1.RC3_MIN , packet1.RC4_MAX , packet1.RC4_MIN , packet1.RC5_MAX , packet1.RC5_MIN , packet1.RC6_MAX , packet1.RC6_MIN , packet1.RC7_MAX , packet1.RC7_MIN , packet1.RC8_MAX , packet1.RC8_MIN , packet1.RC9_MAX , packet1.RC9_MIN , packet1.RC10_MAX , packet1.RC10_MIN , packet1.RC11_MAX , packet1.RC11_MIN , packet1.RC12_MAX , packet1.RC12_MIN );
    mavlink_msg_param_calib_rc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_param_calib_rc_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.RC1_MAX , packet1.RC1_MIN , packet1.RC2_MAX , packet1.RC2_MIN , packet1.RC3_MAX , packet1.RC3_MIN , packet1.RC4_MAX , packet1.RC4_MIN , packet1.RC5_MAX , packet1.RC5_MIN , packet1.RC6_MAX , packet1.RC6_MIN , packet1.RC7_MAX , packet1.RC7_MIN , packet1.RC8_MAX , packet1.RC8_MIN , packet1.RC9_MAX , packet1.RC9_MIN , packet1.RC10_MAX , packet1.RC10_MIN , packet1.RC11_MAX , packet1.RC11_MIN , packet1.RC12_MAX , packet1.RC12_MIN );
    mavlink_msg_param_calib_rc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_param_calib_rc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_param_calib_rc_send(MAVLINK_COMM_1 , packet1.RC1_MAX , packet1.RC1_MIN , packet1.RC2_MAX , packet1.RC2_MIN , packet1.RC3_MAX , packet1.RC3_MIN , packet1.RC4_MAX , packet1.RC4_MIN , packet1.RC5_MAX , packet1.RC5_MIN , packet1.RC6_MAX , packet1.RC6_MIN , packet1.RC7_MAX , packet1.RC7_MIN , packet1.RC8_MAX , packet1.RC8_MIN , packet1.RC9_MAX , packet1.RC9_MIN , packet1.RC10_MAX , packet1.RC10_MIN , packet1.RC11_MAX , packet1.RC11_MIN , packet1.RC12_MAX , packet1.RC12_MIN );
    mavlink_msg_param_calib_rc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_attitude_pitch_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Attitude_PITCH_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_attitude_pitch_pid_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_attitude_pitch_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.MC_PITCH_P = packet_in.MC_PITCH_P;
        packet1.MC_PITCHRATE_P = packet_in.MC_PITCHRATE_P;
        packet1.MC_PITCHRATE_I = packet_in.MC_PITCHRATE_I;
        packet1.MC_PITCHRATE_D = packet_in.MC_PITCHRATE_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_pitch_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_attitude_pitch_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_pitch_pid_pack(system_id, component_id, &msg , packet1.MC_PITCH_P , packet1.MC_PITCHRATE_P , packet1.MC_PITCHRATE_I , packet1.MC_PITCHRATE_D );
    mavlink_msg_attitude_pitch_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_pitch_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MC_PITCH_P , packet1.MC_PITCHRATE_P , packet1.MC_PITCHRATE_I , packet1.MC_PITCHRATE_D );
    mavlink_msg_attitude_pitch_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_attitude_pitch_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_pitch_pid_send(MAVLINK_COMM_1 , packet1.MC_PITCH_P , packet1.MC_PITCHRATE_P , packet1.MC_PITCHRATE_I , packet1.MC_PITCHRATE_D );
    mavlink_msg_attitude_pitch_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_attitude_roll_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Attitude_ROLL_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_attitude_roll_pid_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_attitude_roll_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.MC_ROLL_P = packet_in.MC_ROLL_P;
        packet1.MC_ROLLRATE_P = packet_in.MC_ROLLRATE_P;
        packet1.MC_ROLLRATE_I = packet_in.MC_ROLLRATE_I;
        packet1.MC_ROLLRATE_D = packet_in.MC_ROLLRATE_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_roll_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_attitude_roll_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_roll_pid_pack(system_id, component_id, &msg , packet1.MC_ROLL_P , packet1.MC_ROLLRATE_P , packet1.MC_ROLLRATE_I , packet1.MC_ROLLRATE_D );
    mavlink_msg_attitude_roll_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_roll_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MC_ROLL_P , packet1.MC_ROLLRATE_P , packet1.MC_ROLLRATE_I , packet1.MC_ROLLRATE_D );
    mavlink_msg_attitude_roll_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_attitude_roll_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_roll_pid_send(MAVLINK_COMM_1 , packet1.MC_ROLL_P , packet1.MC_ROLLRATE_P , packet1.MC_ROLLRATE_I , packet1.MC_ROLLRATE_D );
    mavlink_msg_attitude_roll_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_attitude_yaw_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Attitude_YAW_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_attitude_yaw_pid_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_attitude_yaw_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.MC_YAW_P = packet_in.MC_YAW_P;
        packet1.MC_YAWRATE_P = packet_in.MC_YAWRATE_P;
        packet1.MC_YAWRATE_I = packet_in.MC_YAWRATE_I;
        packet1.MC_YAWRATE_D = packet_in.MC_YAWRATE_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_yaw_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_attitude_yaw_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_yaw_pid_pack(system_id, component_id, &msg , packet1.MC_YAW_P , packet1.MC_YAWRATE_P , packet1.MC_YAWRATE_I , packet1.MC_YAWRATE_D );
    mavlink_msg_attitude_yaw_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_yaw_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MC_YAW_P , packet1.MC_YAWRATE_P , packet1.MC_YAWRATE_I , packet1.MC_YAWRATE_D );
    mavlink_msg_attitude_yaw_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_attitude_yaw_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_attitude_yaw_pid_send(MAVLINK_COMM_1 , packet1.MC_YAW_P , packet1.MC_YAWRATE_P , packet1.MC_YAWRATE_I , packet1.MC_YAWRATE_D );
    mavlink_msg_attitude_yaw_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_position_x_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Position_X_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_position_x_pid_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_position_x_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.MPC_X_P = packet_in.MPC_X_P;
        packet1.MPC_XRATE_P = packet_in.MPC_XRATE_P;
        packet1.MPC_XRATE_I = packet_in.MPC_XRATE_I;
        packet1.MPC_XRATE_D = packet_in.MPC_XRATE_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Position_X_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Position_X_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_x_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_position_x_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_x_pid_pack(system_id, component_id, &msg , packet1.MPC_X_P , packet1.MPC_XRATE_P , packet1.MPC_XRATE_I , packet1.MPC_XRATE_D );
    mavlink_msg_position_x_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_x_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MPC_X_P , packet1.MPC_XRATE_P , packet1.MPC_XRATE_I , packet1.MPC_XRATE_D );
    mavlink_msg_position_x_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_position_x_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_x_pid_send(MAVLINK_COMM_1 , packet1.MPC_X_P , packet1.MPC_XRATE_P , packet1.MPC_XRATE_I , packet1.MPC_XRATE_D );
    mavlink_msg_position_x_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_position_y_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Position_Y_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_position_y_pid_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_position_y_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.MPC_Y_P = packet_in.MPC_Y_P;
        packet1.MPC_YRATE_P = packet_in.MPC_YRATE_P;
        packet1.MPC_YRATE_I = packet_in.MPC_YRATE_I;
        packet1.MPC_YRATE_D = packet_in.MPC_YRATE_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_y_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_position_y_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_y_pid_pack(system_id, component_id, &msg , packet1.MPC_Y_P , packet1.MPC_YRATE_P , packet1.MPC_YRATE_I , packet1.MPC_YRATE_D );
    mavlink_msg_position_y_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_y_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MPC_Y_P , packet1.MPC_YRATE_P , packet1.MPC_YRATE_I , packet1.MPC_YRATE_D );
    mavlink_msg_position_y_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_position_y_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_y_pid_send(MAVLINK_COMM_1 , packet1.MPC_Y_P , packet1.MPC_YRATE_P , packet1.MPC_YRATE_I , packet1.MPC_YRATE_D );
    mavlink_msg_position_y_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_position_z_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Position_Z_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_position_z_pid_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_position_z_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.MPC_Z_P = packet_in.MPC_Z_P;
        packet1.MPC_ZRATE_P = packet_in.MPC_ZRATE_P;
        packet1.MPC_ZRATE_I = packet_in.MPC_ZRATE_I;
        packet1.MPC_ZRATE_D = packet_in.MPC_ZRATE_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_z_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_position_z_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_z_pid_pack(system_id, component_id, &msg , packet1.MPC_Z_P , packet1.MPC_ZRATE_P , packet1.MPC_ZRATE_I , packet1.MPC_ZRATE_D );
    mavlink_msg_position_z_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_z_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MPC_Z_P , packet1.MPC_ZRATE_P , packet1.MPC_ZRATE_I , packet1.MPC_ZRATE_D );
    mavlink_msg_position_z_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_position_z_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_position_z_pid_send(MAVLINK_COMM_1 , packet1.MPC_Z_P , packet1.MPC_ZRATE_P , packet1.MPC_ZRATE_I , packet1.MPC_ZRATE_D );
    mavlink_msg_position_z_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_pid_set_confirm(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PID_SET_Confirm >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_pid_set_confirm_t packet_in = {
        17.0,45.0,73.0,101.0,"QRSTUV"
    };
    mavlink_pid_set_confirm_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.param_1 = packet_in.param_1;
        packet1.param_2 = packet_in.param_2;
        packet1.param_3 = packet_in.param_3;
        packet1.param_4 = packet_in.param_4;
        
        mav_array_memcpy(packet1.PID_NAME, packet_in.PID_NAME, sizeof(char)*7);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PID_SET_Confirm_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PID_SET_Confirm_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_set_confirm_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_pid_set_confirm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_set_confirm_pack(system_id, component_id, &msg , packet1.PID_NAME , packet1.param_1 , packet1.param_2 , packet1.param_3 , packet1.param_4 );
    mavlink_msg_pid_set_confirm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_set_confirm_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.PID_NAME , packet1.param_1 , packet1.param_2 , packet1.param_3 , packet1.param_4 );
    mavlink_msg_pid_set_confirm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_pid_set_confirm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_pid_set_confirm_send(MAVLINK_COMM_1 , packet1.PID_NAME , packet1.param_1 , packet1.param_2 , packet1.param_3 , packet1.param_4 );
    mavlink_msg_pid_set_confirm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_status_t packet_in = {
        963497464,17443,17547,17651,17755,41,108,{ 175, 176 },53
    };
    mavlink_solar_clean_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.running_time = packet_in.running_time;
        packet1.move_speed = packet_in.move_speed;
        packet1.position = packet_in.position;
        packet1.voltage_battery = packet_in.voltage_battery;
        packet1.current_battery = packet_in.current_battery;
        packet1.move_mode_status = packet_in.move_mode_status;
        packet1.cleaner_status = packet_in.cleaner_status;
        packet1.battery_remaining = packet_in.battery_remaining;
        
        mav_array_memcpy(packet1.working_alarm_now, packet_in.working_alarm_now, sizeof(uint8_t)*2);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_status_pack(system_id, component_id, &msg , packet1.move_mode_status , packet1.move_speed , packet1.cleaner_status , packet1.position , packet1.running_time , packet1.working_alarm_now , packet1.voltage_battery , packet1.current_battery , packet1.battery_remaining );
    mavlink_msg_solar_clean_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.move_mode_status , packet1.move_speed , packet1.cleaner_status , packet1.position , packet1.running_time , packet1.working_alarm_now , packet1.voltage_battery , packet1.current_battery , packet1.battery_remaining );
    mavlink_msg_solar_clean_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_status_send(MAVLINK_COMM_1 , packet1.move_mode_status , packet1.move_speed , packet1.cleaner_status , packet1.position , packet1.running_time , packet1.working_alarm_now , packet1.voltage_battery , packet1.current_battery , packet1.battery_remaining );
    mavlink_msg_solar_clean_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_control_t packet_in = {
        17235,139,206,{ 17, 18 }
    };
    mavlink_solar_clean_control_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.move_speed_control = packet_in.move_speed_control;
        packet1.move_mode_control = packet_in.move_mode_control;
        packet1.cleaner_control = packet_in.cleaner_control;
        
        mav_array_memcpy(packet1.set_working_alarm, packet_in.set_working_alarm, sizeof(uint8_t)*2);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_control_pack(system_id, component_id, &msg , packet1.move_mode_control , packet1.move_speed_control , packet1.cleaner_control , packet1.set_working_alarm );
    mavlink_msg_solar_clean_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.move_mode_control , packet1.move_speed_control , packet1.cleaner_control , packet1.set_working_alarm );
    mavlink_msg_solar_clean_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_control_send(MAVLINK_COMM_1 , packet1.move_mode_control , packet1.move_speed_control , packet1.cleaner_control , packet1.set_working_alarm );
    mavlink_msg_solar_clean_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_temperature(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_TEMPERATURE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_temperature_t packet_in = {
        963497464,{ 45.0, 46.0, 47.0, 48.0, 49.0, 50.0, 51.0, 52.0, 53.0, 54.0, 55.0, 56.0, 57.0, 58.0, 59.0, 60.0, 61.0, 62.0, 63.0, 64.0, 65.0, 66.0, 67.0, 68.0, 69.0, 70.0, 71.0, 72.0, 73.0, 74.0 }
    };
    mavlink_solar_clean_temperature_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.temperature_enabled = packet_in.temperature_enabled;
        
        mav_array_memcpy(packet1.temperature, packet_in.temperature, sizeof(float)*30);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_TEMPERATURE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_TEMPERATURE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_temperature_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_pack(system_id, component_id, &msg , packet1.temperature_enabled , packet1.temperature );
    mavlink_msg_solar_clean_temperature_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.temperature_enabled , packet1.temperature );
    mavlink_msg_solar_clean_temperature_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_temperature_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_send(MAVLINK_COMM_1 , packet1.temperature_enabled , packet1.temperature );
    mavlink_msg_solar_clean_temperature_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_comm(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_COMM >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_comm_t packet_in = {
        "ABCDEFGHIJKLMNO","QRSTUVWXYZABCDE","GHIJKLMNOPQRSTU","WXYZABCDEFGHIJK"
    };
    mavlink_solar_clean_comm_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        mav_array_memcpy(packet1.wifi_name, packet_in.wifi_name, sizeof(char)*16);
        mav_array_memcpy(packet1.wifi_passwd, packet_in.wifi_passwd, sizeof(char)*16);
        mav_array_memcpy(packet1.server_ip, packet_in.server_ip, sizeof(char)*16);
        mav_array_memcpy(packet1.server_tcp_port, packet_in.server_tcp_port, sizeof(char)*16);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_COMM_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_COMM_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_comm_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_comm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_comm_pack(system_id, component_id, &msg , packet1.wifi_name , packet1.wifi_passwd , packet1.server_ip , packet1.server_tcp_port );
    mavlink_msg_solar_clean_comm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_comm_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.wifi_name , packet1.wifi_passwd , packet1.server_ip , packet1.server_tcp_port );
    mavlink_msg_solar_clean_comm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_comm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_comm_send(MAVLINK_COMM_1 , packet1.wifi_name , packet1.wifi_passwd , packet1.server_ip , packet1.server_tcp_port );
    mavlink_msg_solar_clean_comm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_io(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_IO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_io_t packet_in = {
        5,72
    };
    mavlink_solar_clean_io_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.PLC_DI = packet_in.PLC_DI;
        packet1.PLC_DO = packet_in.PLC_DO;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_IO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_IO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_io_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_io_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_io_pack(system_id, component_id, &msg , packet1.PLC_DI , packet1.PLC_DO );
    mavlink_msg_solar_clean_io_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_io_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.PLC_DI , packet1.PLC_DO );
    mavlink_msg_solar_clean_io_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_io_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_io_send(MAVLINK_COMM_1 , packet1.PLC_DI , packet1.PLC_DO );
    mavlink_msg_solar_clean_io_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_paramater(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_PARAMATER >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_paramater_t packet_in = {
        963497464,17443,17547
    };
    mavlink_solar_clean_paramater_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.heartbeat_cycle = packet_in.heartbeat_cycle;
        packet1.length_of_working_panel = packet_in.length_of_working_panel;
        packet1.width_of_solar_clean = packet_in.width_of_solar_clean;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_PARAMATER_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_PARAMATER_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_paramater_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_paramater_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_paramater_pack(system_id, component_id, &msg , packet1.length_of_working_panel , packet1.width_of_solar_clean , packet1.heartbeat_cycle );
    mavlink_msg_solar_clean_paramater_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_paramater_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.length_of_working_panel , packet1.width_of_solar_clean , packet1.heartbeat_cycle );
    mavlink_msg_solar_clean_paramater_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_paramater_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_paramater_send(MAVLINK_COMM_1 , packet1.length_of_working_panel , packet1.width_of_solar_clean , packet1.heartbeat_cycle );
    mavlink_msg_solar_clean_paramater_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_msg_require(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_MSG_REQUIRE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_msg_require_t packet_in = {
        5
    };
    mavlink_solar_clean_msg_require_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.message_id_require = packet_in.message_id_require;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_MSG_REQUIRE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_MSG_REQUIRE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_msg_require_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_msg_require_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_msg_require_pack(system_id, component_id, &msg , packet1.message_id_require );
    mavlink_msg_solar_clean_msg_require_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_msg_require_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.message_id_require );
    mavlink_msg_solar_clean_msg_require_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_msg_require_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_msg_require_send(MAVLINK_COMM_1 , packet1.message_id_require );
    mavlink_msg_solar_clean_msg_require_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_solar_clean_temperature_channel_select(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SOLAR_CLEAN_TEMPERATURE_CHANNEL_SELECT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_solar_clean_temperature_channel_select_t packet_in = {
        963497464
    };
    mavlink_solar_clean_temperature_channel_select_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.number_of_temperature = packet_in.number_of_temperature;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SOLAR_CLEAN_TEMPERATURE_CHANNEL_SELECT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SOLAR_CLEAN_TEMPERATURE_CHANNEL_SELECT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_channel_select_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_solar_clean_temperature_channel_select_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_channel_select_pack(system_id, component_id, &msg , packet1.number_of_temperature );
    mavlink_msg_solar_clean_temperature_channel_select_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_channel_select_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.number_of_temperature );
    mavlink_msg_solar_clean_temperature_channel_select_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_solar_clean_temperature_channel_select_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_solar_clean_temperature_channel_select_send(MAVLINK_COMM_1 , packet1.number_of_temperature );
    mavlink_msg_solar_clean_temperature_channel_select_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_qgcmission(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Qgcmission >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_qgcmission_t packet_in = {
        17.0,45.0,73.0,41
    };
    mavlink_qgcmission_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Qgcmission_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Qgcmission_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcmission_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_qgcmission_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcmission_pack(system_id, component_id, &msg , packet1.length , packet1.width , packet1.height , packet1.times );
    mavlink_msg_qgcmission_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcmission_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.length , packet1.width , packet1.height , packet1.times );
    mavlink_msg_qgcmission_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_qgcmission_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgcmission_send(MAVLINK_COMM_1 , packet1.length , packet1.width , packet1.height , packet1.times );
    mavlink_msg_qgcmission_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_param_calib_rc(system_id, component_id, last_msg);
    mavlink_test_attitude_pitch_pid(system_id, component_id, last_msg);
    mavlink_test_attitude_roll_pid(system_id, component_id, last_msg);
    mavlink_test_attitude_yaw_pid(system_id, component_id, last_msg);
    mavlink_test_position_x_pid(system_id, component_id, last_msg);
    mavlink_test_position_y_pid(system_id, component_id, last_msg);
    mavlink_test_position_z_pid(system_id, component_id, last_msg);
    mavlink_test_pid_set_confirm(system_id, component_id, last_msg);
    mavlink_test_solar_clean_status(system_id, component_id, last_msg);
    mavlink_test_solar_clean_control(system_id, component_id, last_msg);
    mavlink_test_solar_clean_temperature(system_id, component_id, last_msg);
    mavlink_test_solar_clean_comm(system_id, component_id, last_msg);
    mavlink_test_solar_clean_io(system_id, component_id, last_msg);
    mavlink_test_solar_clean_paramater(system_id, component_id, last_msg);
    mavlink_test_solar_clean_msg_require(system_id, component_id, last_msg);
    mavlink_test_solar_clean_temperature_channel_select(system_id, component_id, last_msg);
    mavlink_test_qgcmission(system_id, component_id, last_msg);
