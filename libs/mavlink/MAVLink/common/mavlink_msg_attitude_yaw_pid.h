...
#define MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN 16
                               ...
                               float MC_YAW_P, float MC_YAWRATE_P, float MC_YAWRATE_I, float MC_YAWRATE_D)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_CRC);
}
                                   ...
                                   float MC_YAW_P,float MC_YAWRATE_P,float MC_YAWRATE_I,float MC_YAWRATE_D)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Attitude_YAW_PID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_CRC);
}
...
static inline void mavlink_msg_attitude_yaw_pid_send(mavlink_channel_t chan, float MC_YAW_P, float MC_YAWRATE_P, float MC_YAWRATE_I, float MC_YAWRATE_D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_YAW_PID, buf, MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_CRC);
#else
    mavlink_attitude_yaw_pid_t packet;
    packet.MC_YAW_P = MC_YAW_P;
    packet.MC_YAWRATE_P = MC_YAWRATE_P;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_YAW_PID, (const char *)&packet, MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_attitude_yaw_pid_send_struct(mavlink_channel_t chan, const mavlink_attitude_yaw_pid_t* attitude_yaw_pid)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_yaw_pid_send(chan, attitude_yaw_pid->MC_YAW_P, attitude_yaw_pid->MC_YAWRATE_P, attitude_yaw_pid->MC_YAWRATE_I, attitude_yaw_pid->MC_YAWRATE_D);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_YAW_PID, (const char *)attitude_yaw_pid, MAVLINK_MSG_ID_Attitude_YAW_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_LEN, MAVLINK_MSG_ID_Attitude_YAW_PID_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Attitude_YAW_PID_LEN? msg->len : MAVLINK_MSG_ID_Attitude_YAW_PID_LEN;
        memset(attitude_yaw_pid, 0, MAVLINK_MSG_ID_Attitude_YAW_PID_LEN);
    memcpy(attitude_yaw_pid, _MAV_PAYLOAD(msg), len);
#endif
}
