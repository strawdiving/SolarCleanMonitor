...
#define MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN 16
                               ...
                               float MC_ROLL_P, float MC_ROLLRATE_P, float MC_ROLLRATE_I, float MC_ROLLRATE_D)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_CRC);
}
                                   ...
                                   float MC_ROLL_P,float MC_ROLLRATE_P,float MC_ROLLRATE_I,float MC_ROLLRATE_D)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Attitude_ROLL_PID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_CRC);
}
...
static inline void mavlink_msg_attitude_roll_pid_send(mavlink_channel_t chan, float MC_ROLL_P, float MC_ROLLRATE_P, float MC_ROLLRATE_I, float MC_ROLLRATE_D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_ROLL_PID, buf, MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_CRC);
#else
    mavlink_attitude_roll_pid_t packet;
    packet.MC_ROLL_P = MC_ROLL_P;
    packet.MC_ROLLRATE_P = MC_ROLLRATE_P;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_ROLL_PID, (const char *)&packet, MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_attitude_roll_pid_send_struct(mavlink_channel_t chan, const mavlink_attitude_roll_pid_t* attitude_roll_pid)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_roll_pid_send(chan, attitude_roll_pid->MC_ROLL_P, attitude_roll_pid->MC_ROLLRATE_P, attitude_roll_pid->MC_ROLLRATE_I, attitude_roll_pid->MC_ROLLRATE_D);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_ROLL_PID, (const char *)attitude_roll_pid, MAVLINK_MSG_ID_Attitude_ROLL_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN, MAVLINK_MSG_ID_Attitude_ROLL_PID_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN? msg->len : MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN;
        memset(attitude_roll_pid, 0, MAVLINK_MSG_ID_Attitude_ROLL_PID_LEN);
    memcpy(attitude_roll_pid, _MAV_PAYLOAD(msg), len);
#endif
}
