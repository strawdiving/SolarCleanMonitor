...
#define MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN 16
#define MAVLINK_MSG_ID_155_LEN 16
#define MAVLINK_MSG_ID_155_MIN_LEN 16
                               ...
                               float MPC_Y_P, float MPC_YRATE_P, float MPC_YRATE_I, float MPC_YRATE_D)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Y_PID_LEN, MAVLINK_MSG_ID_Position_Y_PID_CRC);
}
                                   ...
                                   float MPC_Y_P,float MPC_YRATE_P,float MPC_YRATE_I,float MPC_YRATE_D)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Position_Y_PID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Y_PID_LEN, MAVLINK_MSG_ID_Position_Y_PID_CRC);
}
...
static inline void mavlink_msg_position_y_pid_send(mavlink_channel_t chan, float MPC_Y_P, float MPC_YRATE_P, float MPC_YRATE_I, float MPC_YRATE_D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_Y_PID, buf, MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Y_PID_LEN, MAVLINK_MSG_ID_Position_Y_PID_CRC);
#else
    mavlink_position_y_pid_t packet;
    packet.MPC_Y_P = MPC_Y_P;
    packet.MPC_YRATE_P = MPC_YRATE_P;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_Y_PID, (const char *)&packet, MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Y_PID_LEN, MAVLINK_MSG_ID_Position_Y_PID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_position_y_pid_send_struct(mavlink_channel_t chan, const mavlink_position_y_pid_t* position_y_pid)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_position_y_pid_send(chan, position_y_pid->MPC_Y_P, position_y_pid->MPC_YRATE_P, position_y_pid->MPC_YRATE_I, position_y_pid->MPC_YRATE_D);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_Y_PID, (const char *)position_y_pid, MAVLINK_MSG_ID_Position_Y_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Y_PID_LEN, MAVLINK_MSG_ID_Position_Y_PID_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Position_Y_PID_LEN? msg->len : MAVLINK_MSG_ID_Position_Y_PID_LEN;
        memset(position_y_pid, 0, MAVLINK_MSG_ID_Position_Y_PID_LEN);
    memcpy(position_y_pid, _MAV_PAYLOAD(msg), len);
#endif
}
