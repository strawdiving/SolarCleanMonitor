...
#define MAVLINK_MSG_ID_param_calib_rc_MIN_LEN 48
#define MAVLINK_MSG_ID_150_LEN 48
#define MAVLINK_MSG_ID_150_MIN_LEN 48
                               ...
                               uint16_t RC1_MAX, uint16_t RC1_MIN, uint16_t RC2_MAX, uint16_t RC2_MIN, uint16_t RC3_MAX, uint16_t RC3_MIN, uint16_t RC4_MAX, uint16_t RC4_MIN, uint16_t RC5_MAX, uint16_t RC5_MIN, uint16_t RC6_MAX, uint16_t RC6_MIN, uint16_t RC7_MAX, uint16_t RC7_MIN, uint16_t RC8_MAX, uint16_t RC8_MIN, uint16_t RC9_MAX, uint16_t RC9_MIN, uint16_t RC10_MAX, uint16_t RC10_MIN, uint16_t RC11_MAX, uint16_t RC11_MIN, uint16_t RC12_MAX, uint16_t RC12_MIN)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_param_calib_rc_MIN_LEN, MAVLINK_MSG_ID_param_calib_rc_LEN, MAVLINK_MSG_ID_param_calib_rc_CRC);
}
                                   ...
                                   uint16_t RC1_MAX,uint16_t RC1_MIN,uint16_t RC2_MAX,uint16_t RC2_MIN,uint16_t RC3_MAX,uint16_t RC3_MIN,uint16_t RC4_MAX,uint16_t RC4_MIN,uint16_t RC5_MAX,uint16_t RC5_MIN,uint16_t RC6_MAX,uint16_t RC6_MIN,uint16_t RC7_MAX,uint16_t RC7_MIN,uint16_t RC8_MAX,uint16_t RC8_MIN,uint16_t RC9_MAX,uint16_t RC9_MIN,uint16_t RC10_MAX,uint16_t RC10_MIN,uint16_t RC11_MAX,uint16_t RC11_MIN,uint16_t RC12_MAX,uint16_t RC12_MIN)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_param_calib_rc;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_param_calib_rc_MIN_LEN, MAVLINK_MSG_ID_param_calib_rc_LEN, MAVLINK_MSG_ID_param_calib_rc_CRC);
}
...
static inline void mavlink_msg_param_calib_rc_send(mavlink_channel_t chan, uint16_t RC1_MAX, uint16_t RC1_MIN, uint16_t RC2_MAX, uint16_t RC2_MIN, uint16_t RC3_MAX, uint16_t RC3_MIN, uint16_t RC4_MAX, uint16_t RC4_MIN, uint16_t RC5_MAX, uint16_t RC5_MIN, uint16_t RC6_MAX, uint16_t RC6_MIN, uint16_t RC7_MAX, uint16_t RC7_MIN, uint16_t RC8_MAX, uint16_t RC8_MIN, uint16_t RC9_MAX, uint16_t RC9_MIN, uint16_t RC10_MAX, uint16_t RC10_MIN, uint16_t RC11_MAX, uint16_t RC11_MIN, uint16_t RC12_MAX, uint16_t RC12_MIN)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_param_calib_rc, buf, MAVLINK_MSG_ID_param_calib_rc_MIN_LEN, MAVLINK_MSG_ID_param_calib_rc_LEN, MAVLINK_MSG_ID_param_calib_rc_CRC);
#else
    mavlink_param_calib_rc_t packet;
    packet.RC1_MAX = RC1_MAX;
    packet.RC1_MIN = RC1_MIN;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_param_calib_rc, (const char *)&packet, MAVLINK_MSG_ID_param_calib_rc_MIN_LEN, MAVLINK_MSG_ID_param_calib_rc_LEN, MAVLINK_MSG_ID_param_calib_rc_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_param_calib_rc_send_struct(mavlink_channel_t chan, const mavlink_param_calib_rc_t* param_calib_rc)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_calib_rc_send(chan, param_calib_rc->RC1_MAX, param_calib_rc->RC1_MIN, param_calib_rc->RC2_MAX, param_calib_rc->RC2_MIN, param_calib_rc->RC3_MAX, param_calib_rc->RC3_MIN, param_calib_rc->RC4_MAX, param_calib_rc->RC4_MIN, param_calib_rc->RC5_MAX, param_calib_rc->RC5_MIN, param_calib_rc->RC6_MAX, param_calib_rc->RC6_MIN, param_calib_rc->RC7_MAX, param_calib_rc->RC7_MIN, param_calib_rc->RC8_MAX, param_calib_rc->RC8_MIN, param_calib_rc->RC9_MAX, param_calib_rc->RC9_MIN, param_calib_rc->RC10_MAX, param_calib_rc->RC10_MIN, param_calib_rc->RC11_MAX, param_calib_rc->RC11_MIN, param_calib_rc->RC12_MAX, param_calib_rc->RC12_MIN);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_param_calib_rc, (const char *)param_calib_rc, MAVLINK_MSG_ID_param_calib_rc_MIN_LEN, MAVLINK_MSG_ID_param_calib_rc_LEN, MAVLINK_MSG_ID_param_calib_rc_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_param_calib_rc_LEN? msg->len : MAVLINK_MSG_ID_param_calib_rc_LEN;
        memset(param_calib_rc, 0, MAVLINK_MSG_ID_param_calib_rc_LEN);
    memcpy(param_calib_rc, _MAV_PAYLOAD(msg), len);
#endif
}
