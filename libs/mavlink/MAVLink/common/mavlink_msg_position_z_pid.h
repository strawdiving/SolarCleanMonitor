...
#define MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN 16
#define MAVLINK_MSG_ID_156_LEN 16
#define MAVLINK_MSG_ID_156_MIN_LEN 16
                               ...
                               float MPC_Z_P, float MPC_ZRATE_P, float MPC_ZRATE_I, float MPC_ZRATE_D)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Z_PID_LEN, MAVLINK_MSG_ID_Position_Z_PID_CRC);
}
                                   ...
                                   float MPC_Z_P,float MPC_ZRATE_P,float MPC_ZRATE_I,float MPC_ZRATE_D)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Position_Z_PID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Z_PID_LEN, MAVLINK_MSG_ID_Position_Z_PID_CRC);
}
...
static inline void mavlink_msg_position_z_pid_send(mavlink_channel_t chan, float MPC_Z_P, float MPC_ZRATE_P, float MPC_ZRATE_I, float MPC_ZRATE_D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_Z_PID, buf, MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Z_PID_LEN, MAVLINK_MSG_ID_Position_Z_PID_CRC);
#else
    mavlink_position_z_pid_t packet;
    packet.MPC_Z_P = MPC_Z_P;
    packet.MPC_ZRATE_P = MPC_ZRATE_P;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_Z_PID, (const char *)&packet, MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Z_PID_LEN, MAVLINK_MSG_ID_Position_Z_PID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_position_z_pid_send_struct(mavlink_channel_t chan, const mavlink_position_z_pid_t* position_z_pid)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_position_z_pid_send(chan, position_z_pid->MPC_Z_P, position_z_pid->MPC_ZRATE_P, position_z_pid->MPC_ZRATE_I, position_z_pid->MPC_ZRATE_D);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_Z_PID, (const char *)position_z_pid, MAVLINK_MSG_ID_Position_Z_PID_MIN_LEN, MAVLINK_MSG_ID_Position_Z_PID_LEN, MAVLINK_MSG_ID_Position_Z_PID_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Position_Z_PID_LEN? msg->len : MAVLINK_MSG_ID_Position_Z_PID_LEN;
        memset(position_z_pid, 0, MAVLINK_MSG_ID_Position_Z_PID_LEN);
    memcpy(position_z_pid, _MAV_PAYLOAD(msg), len);
#endif
}
