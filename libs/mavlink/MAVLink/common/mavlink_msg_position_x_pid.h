...
#define MAVLINK_MSG_ID_Position_X_PID_MIN_LEN 16
                               ...
                               float MPC_X_P, float MPC_XRATE_P, float MPC_XRATE_I, float MPC_XRATE_D)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Position_X_PID_MIN_LEN, MAVLINK_MSG_ID_Position_X_PID_LEN, MAVLINK_MSG_ID_Position_X_PID_CRC);
}
                                   ...
                                   float MPC_X_P,float MPC_XRATE_P,float MPC_XRATE_I,float MPC_XRATE_D)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Position_X_PID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Position_X_PID_MIN_LEN, MAVLINK_MSG_ID_Position_X_PID_LEN, MAVLINK_MSG_ID_Position_X_PID_CRC);
}
...
static inline void mavlink_msg_position_x_pid_send(mavlink_channel_t chan, float MPC_X_P, float MPC_XRATE_P, float MPC_XRATE_I, float MPC_XRATE_D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_X_PID, buf, MAVLINK_MSG_ID_Position_X_PID_MIN_LEN, MAVLINK_MSG_ID_Position_X_PID_LEN, MAVLINK_MSG_ID_Position_X_PID_CRC);
#else
    mavlink_position_x_pid_t packet;
    packet.MPC_X_P = MPC_X_P;
    packet.MPC_XRATE_P = MPC_XRATE_P;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_X_PID, (const char *)&packet, MAVLINK_MSG_ID_Position_X_PID_MIN_LEN, MAVLINK_MSG_ID_Position_X_PID_LEN, MAVLINK_MSG_ID_Position_X_PID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_position_x_pid_send_struct(mavlink_channel_t chan, const mavlink_position_x_pid_t* position_x_pid)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_position_x_pid_send(chan, position_x_pid->MPC_X_P, position_x_pid->MPC_XRATE_P, position_x_pid->MPC_XRATE_I, position_x_pid->MPC_XRATE_D);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Position_X_PID, (const char *)position_x_pid, MAVLINK_MSG_ID_Position_X_PID_MIN_LEN, MAVLINK_MSG_ID_Position_X_PID_LEN, MAVLINK_MSG_ID_Position_X_PID_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Position_X_PID_LEN? msg->len : MAVLINK_MSG_ID_Position_X_PID_LEN;
        memset(position_x_pid, 0, MAVLINK_MSG_ID_Position_X_PID_LEN);
    memcpy(position_x_pid, _MAV_PAYLOAD(msg), len);
#endif
}
