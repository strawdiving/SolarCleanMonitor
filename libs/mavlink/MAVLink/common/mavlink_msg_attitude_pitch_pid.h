...
#define MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN 16
                               ...
                               float MC_PITCH_P, float MC_PITCHRATE_P, float MC_PITCHRATE_I, float MC_PITCHRATE_D)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_CRC);
}
                                   ...
                                   float MC_PITCH_P,float MC_PITCHRATE_P,float MC_PITCHRATE_I,float MC_PITCHRATE_D)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Attitude_PITCH_PID;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_CRC);
}
...
static inline void mavlink_msg_attitude_pitch_pid_send(mavlink_channel_t chan, float MC_PITCH_P, float MC_PITCHRATE_P, float MC_PITCHRATE_I, float MC_PITCHRATE_D)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_PITCH_PID, buf, MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_CRC);
#else
    mavlink_attitude_pitch_pid_t packet;
    packet.MC_PITCH_P = MC_PITCH_P;
    packet.MC_PITCHRATE_P = MC_PITCHRATE_P;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_PITCH_PID, (const char *)&packet, MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_attitude_pitch_pid_send_struct(mavlink_channel_t chan, const mavlink_attitude_pitch_pid_t* attitude_pitch_pid)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_pitch_pid_send(chan, attitude_pitch_pid->MC_PITCH_P, attitude_pitch_pid->MC_PITCHRATE_P, attitude_pitch_pid->MC_PITCHRATE_I, attitude_pitch_pid->MC_PITCHRATE_D);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Attitude_PITCH_PID, (const char *)attitude_pitch_pid, MAVLINK_MSG_ID_Attitude_PITCH_PID_MIN_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN, MAVLINK_MSG_ID_Attitude_PITCH_PID_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN? msg->len : MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN;
        memset(attitude_pitch_pid, 0, MAVLINK_MSG_ID_Attitude_PITCH_PID_LEN);
    memcpy(attitude_pitch_pid, _MAV_PAYLOAD(msg), len);
#endif
}
