...
#define MAVLINK_MSG_ID_Qgcmission_MIN_LEN 13
#define MAVLINK_MSG_ID_224_LEN 13
#define MAVLINK_MSG_ID_224_MIN_LEN 13
                               ...
                               float length, float width, float height, uint8_t times)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Qgcmission_MIN_LEN, MAVLINK_MSG_ID_Qgcmission_LEN, MAVLINK_MSG_ID_Qgcmission_CRC);
}
                                   ...
                                   float length,float width,float height,uint8_t times)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Qgcmission;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Qgcmission_MIN_LEN, MAVLINK_MSG_ID_Qgcmission_LEN, MAVLINK_MSG_ID_Qgcmission_CRC);
}
...
static inline void mavlink_msg_qgcmission_send(mavlink_channel_t chan, float length, float width, float height, uint8_t times)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Qgcmission, buf, MAVLINK_MSG_ID_Qgcmission_MIN_LEN, MAVLINK_MSG_ID_Qgcmission_LEN, MAVLINK_MSG_ID_Qgcmission_CRC);
#else
    mavlink_qgcmission_t packet;
    packet.length = length;
    packet.width = width;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Qgcmission, (const char *)&packet, MAVLINK_MSG_ID_Qgcmission_MIN_LEN, MAVLINK_MSG_ID_Qgcmission_LEN, MAVLINK_MSG_ID_Qgcmission_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_qgcmission_send_struct(mavlink_channel_t chan, const mavlink_qgcmission_t* qgcmission)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_qgcmission_send(chan, qgcmission->length, qgcmission->width, qgcmission->height, qgcmission->times);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Qgcmission, (const char *)qgcmission, MAVLINK_MSG_ID_Qgcmission_MIN_LEN, MAVLINK_MSG_ID_Qgcmission_LEN, MAVLINK_MSG_ID_Qgcmission_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Qgcmission_LEN? msg->len : MAVLINK_MSG_ID_Qgcmission_LEN;
        memset(qgcmission, 0, MAVLINK_MSG_ID_Qgcmission_LEN);
    memcpy(qgcmission, _MAV_PAYLOAD(msg), len);
#endif
}
