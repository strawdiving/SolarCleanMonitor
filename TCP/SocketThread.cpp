...
void SocketThread::run()
{
    ...
    connect(_statusTimer,&QTimer::timeout,this,&SocketThread::_statusUpdate);
...
//! [1] //! [2]
    ...
    connect(_tcpSocket,&QTcpSocket::readyRead,this,&SocketThread::_receiveMessage,Qt::DirectConnection);//in the same thread
    connect(_tcpSocket,SIGNAL(error(QAbstractSocket::SocketError)),this,SLOT(_errorMsg(QAbstractSocket::SocketError)));
    connect(_tcpSocket,&QTcpSocket::disconnected,this,&SocketThread::_disconnect,Qt::DirectConnection);
...
void SocketThread::_statusUpdate(void)
{
...
void SocketThread::_receiveMessage()
{
...
void SocketThread::_sendMessage(mavlink_message_t message)
{
...
void SocketThread::_disconnect()
{
    qDebug()<<"disconnected";
    emit socketDisconnect(_socketDescriptor,_tcpSocket);
    _tcpSocket->deleteLater();
    _statusTimer->stop();
    this->quit();
}

 void SocketThread::_errorMsg(QAbstractSocket:: SocketError socketError)
 {
